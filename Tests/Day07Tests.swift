...
final class Day07Tests: XCTestCase {
    func testDay07_1() throws {
        ...
        XCTAssertEqual(d.thrusterSignal(program: [3,23,3,24,1002,24,10,24,1002,23,-1,23,101,5,23,23,1,24,23,23,4,23,99,0,0],
                                        phaseSetting: [0,1,2,3,4]),
                       54321)

        XCTAssertEqual(d.thrusterSignal(program: [3,31,3,32,1002,32,10,32,1001,31,-2,31,1007,31,0,33,
    ...
    func testDay07_2() throws {
        ...
        XCTAssertEqual(d.thrusterSignalFeedback(program: [3,52,1001,52,-5,52,3,53,1,52,56,54,1007,54,5,55,1005,55,26,1001,54,
